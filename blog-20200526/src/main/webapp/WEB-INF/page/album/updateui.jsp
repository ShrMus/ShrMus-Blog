        ...
        <div class="blog-container">
            ...
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">修改相册</span>
                </div>
				<div class="shadow" style="text-align:left;font-size:16px;padding:40px 240px;background:#fff;margin-bottom:15px;">
					<form class="layui-form" id="form-album" action="${pageContext.request.contextPath}/album/update" method="post">
						<input type="hidden" name="albumId" value="${album.albumId}"/>
						<input type="hidden" name="userId" value="${album.userId}"/>
						<table class="layui-table" lay-size="lg" width="100%">
							<tr>
								<td>相册名称</td>
								<td><input class="layui-input" type="text" name="albumName" value="${album.albumName}" placeholder="输入相册名称"/></td>
							</tr>
							<tr>
								<td>相册描述</td>
								<td><input class="layui-input" type="text" name="albumDescription" value="${album.albumDescription}" placeholder="相册描述"/></td>
							</tr>
							<tr>
								<td colspan="2" align="center"><input class="layui-btn layui-btn-primary" type="submit" value="修改"></td>
							</tr>
						</table>
					</form>
                </div>
