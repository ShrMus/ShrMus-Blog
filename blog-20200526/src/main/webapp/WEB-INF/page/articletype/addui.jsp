        ...
        <div class="blog-container">
            ...
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">添加文章类型</span>
                </div>
				<div class="shadow" style="text-align:center;font-size:16px;padding:40px 240px;background:#fff;margin-bottom:15px;">
					<form action="${pageContext.request.contextPath}/articletype/add" method="post">
					<table class="layui-table" lay-size="lg" width="100%">
						<tr>
							<td>类型名称</td>
							<td><input class="layui-input" type="text" name="articleTypeName"  required="required" lay-verify="required"/></td>
						</tr> 
						<tr>
							<td>类型描述</td>
							<td><input class="layui-input" type="text" name="articleTypeDescription"/></td>
						</tr>
						<tr>
							<td colspan="2"><input class="layui-btn" type="submit" value="添加"></td>
						</tr>
					</table>
					</form>
                </div>
