        ...
        <div class="blog-container">
            ...
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">推荐文章</span>
                </div>
                    ...
                    <div class="article shadow">
                        ...
                        <div class="article-footer">
                           <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${article.articleUpdateTime}"/></span>
                            ...
                            <span class="article-viewinfo"><a class="a-notop" href=""><i class="layui-icon-close"></i>&nbsp;不推荐</a></span>
                            <span class="article-viewinfo"><a class="a-top" href=""><i class="layui-icon-ok"></i>&nbsp;推荐</a></span>
...
<script type="text/javascript">
	$(".a-top").click(function(){
		...
		var url = "${pageContext.request.contextPath}/article/top";
		var data = {"articleId":articleId,"articleTop":1};
		$.post(url,data,function(){
			window.location.reload();
		});
	});
	$(".a-notop").click(function(){
		var articleId = $(this).parent().siblings(".input-articleId").val();
		var userId = $(this).parent().siblings(".input-userId").val();
		var url = "${pageContext.request.contextPath}/article/top";
		var data = {"articleId":articleId,"articleTop":0};
		$.post(url,data,function(){
			window.location.reload();
		});
	});
