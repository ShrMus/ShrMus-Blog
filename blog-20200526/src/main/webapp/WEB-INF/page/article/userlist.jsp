...
<head>
    ...
    <title>${sessionScope.user.nickname}的博客 - 斑点博客</title>
    ...
    <div class="blog-body">
        <div class="blog-container">
            <blockquote class="layui-elem-quote sitemap layui-breadcrumb shadow">
                ...
                <a><cite>${sessionScope.user.nickname}的博客</cite></a>
            </blockquote>
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">${sessionScope.user.nickname}的博客</span>
                </div>
	                    ...
	                    <div class="article shadow">
	                        ...
	                        <div class="article-footer">
	                           <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${article.articleUpdateTime}"/></span>
	                            ...
	                            <span><a href="${pageContext.request.contextPath}/article/updateui/${article.articleId}">编辑</a></span>
	                            <span><a href="${pageContext.request.contextPath}/article/delete/${article.articleId}">删除</a></span>
	                            ...
	                            <span class="article-viewinfo"><span style="color:red;">${article.articleIspass eq 2?'审核中':article.articleIspass eq 0?'未通过':''}</span>&nbsp;&nbsp;</span>
	                        </div>
	                    </div>
                    </c:forEach>
                </div>
