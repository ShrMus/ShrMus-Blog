        ...
        <div class="blog-container">
            ...
            <div class="blog-main">
            	<div class="child-nav shadow">
                    <span class="child-nav-btn child-nav-btn-this">审核文章</span>
                </div>
                <div class="blog-main-left">
                    ...
                    <div class="article shadow">
                        ...
                        <div class="article-footer">
                            ...
                            <span class="article-viewinfo"><a class="a-nopass" href=""><i class="layui-icon-close"></i>&nbsp;不通过</a></span>
                            <span class="article-viewinfo"><a class="a-pass" href=""><i class="layui-icon-ok"></i>&nbsp;通过</a></span>
                            <input type="hidden" class="input-articleId" value="${article.articleId}">
                            <input type="hidden" class="input-userId" value="${article.blogUser.id}">
                        </div>
                    </div>
                     </c:forEach>
                </div>
...
<script type="text/javascript">
	$(".a-pass").click(function(){
		var articleId = $(this).parent().siblings(".input-articleId").val();
		var userId = $(this).parent().siblings(".input-userId").val();
		var url = "${pageContext.request.contextPath}/article/verify";
		var data = {"articleId":articleId,"userId":userId,"articleIspass":1};
	...
	$(".a-nopass").click(function(){
		...
		var userId = $(this).parent().siblings(".input-userId").val();
		var url = "${pageContext.request.contextPath}/article/verify";
		var data = {"articleId":articleId,"userId":userId,"articleIspass":0};
		$.post(url,data,function(){
			window.location.reload();
		});
	});
